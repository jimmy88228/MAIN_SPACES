        ...
        <template slot="detail" slot-scope="{ row }">
          <div class="detail-item">
            ...
            <div class="detail-info text-flow">
              <div>
                <p class="detail-name text-flow">文章名称文章名称文章名称文章名称</p>
                <p class="detail-desc">描述描述描述描述描述描述</p>
              </div>
              <div class="detail-time">2022年06月18日 12:00</div>
            </div>
          </div>
        </template>
