  ...
  <Card class="user-benefits">
    ...
    <Form ref="formValidate" :model="formItem" :rules="ruleValidate" :label-width="140">
      <FormItem label="微信注册送积分" prop="user_register_point">
        <InputNumber :min="0" v-model="formItem.user_register_point"></InputNumber>
        <label>积分</label>
      ...
      <FormItem label="绑定手机送积分" prop="bangMobile_point">
        <InputNumber :min="0" v-model="formItem.bangMobile_point"></InputNumber>
        <label>积分</label>
      ...
      <FormItem label="完善资料送积分" prop="member_info_point">
        <InputNumber :min="0" v-model="formItem.member_info_point"></InputNumber>
        <label>积分</label>
      ...
      <FormItem label="关注公众号送积分" prop="subscribe_point">
        <InputNumber :min="0" v-model="formItem.subscribe_point"></InputNumber>
        <label>积分</label>
