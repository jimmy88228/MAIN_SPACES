...
<script>
    ...
    export default{
        name: 'shoppingGuideLabelUserList',
        ...
        methods: {
            ...
            onLoadData(page, reqData){
                ...
                return util.ajax.post(util.apiUrl.ShoppingGuideLabelUserList, reqData).then(e =>{
                    let res = e.data || {};
                    if(res.code) {
                        let data = res.data || {};
            ...
            sendCouponReq(data){
                ShoppingGuideLabelUserSend.call(this, data);
            },
            sendWechatReq(data){
                ShoppingGuideLabelUserSend.call(this, data);
            },
            ...
            handleExport () {
                this.$Modal.confirm({
                    ...
                    cancelText: '取消',
                    onOk: () => {
                        return this.$ajax.post(this.$api.ShoppingGuideLabelUserExport,{
                            tag_id: this.tag_id,
                            searchq: this.formData.searchq,
                            page: 1,
                            pageSize: 20
    ...
    //
    function ShoppingGuideLabelUserSend(data){
       if(!this.tag_id) return;
        this.showSpan = true;
        return util.ajax.post(util.apiUrl.ShoppingGuideLabelUserSend, {
            tag_id: this.tag_id,
            ...data
        }).then(e =>{
            let res = e.data || {};
