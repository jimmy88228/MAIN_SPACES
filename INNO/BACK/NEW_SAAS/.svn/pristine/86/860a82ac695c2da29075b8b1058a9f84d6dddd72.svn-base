	...
	methods: {
		...
		initGoodsList(){
			if( this.info.activity_model == 'auto' ){
				var img = this.$util.apiHost + '/../image/show/assets-images-no_photo.jpg';
				if( this.info.layout == 'one' ){
					this.goodsList = [
						{name:'商品名称1',img_url_thumb: img,sale_price:8,market_price:150,integral:5},
						{name:'商品名称2',img_url_thumb: img,sale_price:9,market_price:140,integral:5},
						{name:'商品名称3',img_url_thumb: img,sale_price:7,market_price:130,integral:5},
					];
				}
				else{
					this.goodsList = [
						{name:'商品名称1',img_url_thumb: img,sale_price:5,market_price:150,integral:5},
						{name:'商品名称2',img_url_thumb: img,sale_price:6,market_price:140,integral:5},
						{name:'商品名称3',img_url_thumb: img,sale_price:7,market_price:130,integral:5},
						{name:'商品名称4',img_url_thumb: img,sale_price:9,market_price:160,integral:5},
						{name:'商品名称5',img_url_thumb: img,sale_price:8,market_price:150,integral:5},
						{name:'商品名称6',img_url_thumb: img,sale_price:7,market_price:170,integral:5},
					];
				}
			}
			else{
