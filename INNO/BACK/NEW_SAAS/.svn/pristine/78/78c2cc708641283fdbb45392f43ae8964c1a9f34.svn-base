...
export default {
  ...
  methods: {
    ...
    onLoadData (page, data) {
      return this.$ajax.post(this.$api.ShopGoodsColorValueList, {
        colorcat_id: this.id,
    ...
    onDelItem (row) {
      return this.$ajax.post(this.$api.ShopGoodsColorValueRemove, {
    ...
    handleSynchronization (arr) {
      ...
      this.$Modal.confirm({
        ...
        onOk: () => {
          this.spinShow = true;
          return this.$ajax.post(this.$api.ShopColorSysnchroAttr, {
            color_ids: arr
          })
          .then((response) => {
