          ...
          <Form ref="formValidate" :model="formItem" :rules="ruleValidate" :label-width="140" v-friendly-errors>
            ...
            <FormItem label="活动">
              ...
              <template v-if="formItem.joinKind == 0">
                <label>单个会员总共</label>
                <InputNumber :min="0" v-model="formItem.totalJoinsTimes"></InputNumber>
                <label>抽奖机会</label>
                <label>每天可参与</label>
                <InputNumber :min="0" v-model="formItem.joinTimesDay"></InputNumber>
                <label>次</label>
              </template>
              <template>
                <label>每次消耗</label>
							...
							<div class="flex">
								...
								<template>
										...
										<FormItem prop="allowWinTimes">
											<InputNumber :min="0" v-model="formItem.allowWinTimes" style="width:120px;"></InputNumber>
										</FormItem>
										<label>&nbsp;次数</label>
								</template>
							</div>
