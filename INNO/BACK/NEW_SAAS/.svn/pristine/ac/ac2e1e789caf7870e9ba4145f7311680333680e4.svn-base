...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            onLoadData(page, reqData){
                ...
                return util.ajax.post(util.apiUrl.VisitLabelUserList, reqData).then(e =>{
                    let res = e.data || {};
                    if(res.code) {
                        let data = res.data || {};
            ...
            sendCouponReq(data){
                VisitLabelUserSend.call(this, data);
            },
            sendWechatReq(data){
                VisitLabelUserSend.call(this, data);
            },
            ...
            handleExport () {
                this.$Modal.confirm({
                    ...
                    cancelText: '取消',
                    onOk: () => {
                        return this.$ajax.post(this.$api.VisitLabelUserExport,{
                            tag_id: this.tag_id,
                            searchq: this.formData.searchq,
                            page: 1,
                            pageSize: 20
    ...
    //
    function VisitLabelUserSend(data){
       if(!this.tag_id) return;
        this.showSpan = true;
        return util.ajax.post(util.apiUrl.VisitLabelUserSend, {
            tag_id: this.tag_id,
            ...data
        }).then(e =>{
            let res = e.data || {};
