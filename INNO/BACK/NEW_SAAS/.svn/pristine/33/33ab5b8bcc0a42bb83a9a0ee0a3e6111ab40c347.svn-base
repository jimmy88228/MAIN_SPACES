...
<template>
	<div class="register-cuser">
		<div class="reg-box">
			<Card class="reg-card">
				<div slot="title">
					<Icon custom="ionmy ion-my-personal-user" class="personal-user"></Icon> 个人用户注册
				</div>
				...
				<Form ref="formValidate" :model="formRegister" :rules="ruleRegister" :label-width="80">
		            ...
		            <div style="text-align:center;">
		            	<Divider />
			            <Button type="success" :loading="registerButtonLoading" @click="registerSubmit" style="width:80px;">注册</Button>
			        </div>
    ...
    registerSubmit () {
        ...
        if (valid) {
          ...
          this.registerButtonLoading = true;
                	...
                	// ajax 发送验证码
                	util.ajax.post(util.apiUrl.cUserRegister, {
