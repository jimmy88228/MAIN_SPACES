...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            onLoadData(page, reqData){
                ...
                return util.ajax.post(util.apiUrl.BasicLabelUserList, reqData).then(e =>{
                    let res = e.data || {};
                    if(res.code) {
                        let data = res.data || {};
            ...
            sendCouponReq(data){
                BasicLabelUserSend.call(this, data);
            },
            sendWechatReq(data){
                BasicLabelUserSend.call(this, data);
            },
            ...
            handleExport () {
                this.$Modal.confirm({
                    ...
                    cancelText: '取消',
                    onOk: () => {
                        return this.$ajax.post(this.$api.BasicLabelUserExport,{
                            tag_id: this.tag_id,
                            searchq: this.formData.searchq,
                            page: 1,
                            pageSize: 20
    ...
    //
    function BasicLabelUserSend(data){
       if(!this.tag_id) return;
        this.showSpan = true;
        return util.ajax.post(util.apiUrl.BasicLabelUserSend, {
            tag_id: this.tag_id,
            ...data
        }).then(e =>{
            let res = e.data || {};
