                ...
                scopedSlots: {
                              ...
                              <div class="img_list_wrap img_list_wrap_add">
                                <div style="display: flex;">
                                  ...
                                  <div class="goods_item_limit">
                                    <p class="goods_item clamp2">名称:{item.goods_name}</p>
                                    <p class="goods_item clamp2">货号:{item.goods_sn}</p>
                  ...
                  handle: ({ row }) => {
                    return <div class="handle_content">
                      {row.handle.edit ? <p><router-link tag="a" to={{name: 'shop-order-info', params: {sn: row.order_id}}} target="_blank" class="edit_item">查看</router-link></p> : <span></span>}
                      {row.handle.message ?
