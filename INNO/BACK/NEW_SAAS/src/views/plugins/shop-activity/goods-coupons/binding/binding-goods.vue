...
export default {
  ...
  methods: {
    onLoadData (page, data) {
      ...
      return this.$ajax.post(this.$api.bindingGoodsList, params)
      .then(response => {
    ...
    addGood (data) {
      return this.$ajax.post(this.$api.bindingGoodsAdd, {
        id: this.id,
    ...
    onDelItem (row) {
      return this.$ajax.post(this.$api.BindingGoodsRemove, {
        id: this.id,
    ...
    handleBatch () {
      this.$Modal.confirm({
        ...
        cancelText: '取消',
        onOk: () => {
          return this.$ajax.post(this.$api.bindingGoodsBatchRemove, {
            id: this.id,
