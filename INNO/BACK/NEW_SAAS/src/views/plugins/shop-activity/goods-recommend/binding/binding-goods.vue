...
export default {
  ...
  methods: {
    onLoadData (page, data) {
      ...
      return this.$ajax.post(this.$api.bindingRecommendGoodsList, params)
      .then(response => {
    ...
    addGood (data) {
      return this.$ajax.post(this.$api.bindingRecommendGoodsAdd, {
        id: this.id,
    ...
    onDelItem (row) {
      return this.$ajax.post(this.$api.bindingRecommendGoodsRemove, {
        id: this.id,
    ...
    handleBatch () {
      this.$Modal.confirm({
        ...
        cancelText: '取消',
        onOk: () => {
          return this.$ajax.post(this.$api.bindingRecommendGoodsBatchRemove, {
            id: this.id,
