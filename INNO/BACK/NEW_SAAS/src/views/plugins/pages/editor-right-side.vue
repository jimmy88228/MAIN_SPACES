...
<template>
	<div class="page-editor-right-side">
		<Tabs :value="currTabName" type="card" :animated="false" @on-click="onTabsClick">
			...
			<TabPane v-if="pageType=='page' || pageType == 'lottery'" name="PAGE" label="页面设置" :style="getPanelStyle">
				<vue-scroll ref="vue-scroll" :ops="scrollOptions">
					<!--页面设置表单-->
					<pageSettingForm :catList="catList" v-if="pageType != 'lottery'"></pageSettingForm>

					<!--微信分享设置-->
					<pageSettingWeixin v-if="canWeixin"></pageSettingWeixin>
					
					<!--营销页面功能设置-->
					<pageSettingLottery></pageSettingLottery>
