<template>
	<div class="activity-content-switch-form">
		...
		<Form ref="formValidate" :model="formItem" :rules="ruleValidate" label-position="left" :label-width="250">
			...
			<FormItem label="显示活动时间">
				<i-switch v-model="formItem.content_switch.show_time" size="large">
					<span slot="open">显示</span>
					<span slot="close">隐藏</span>
				</i-switch>
			</FormItem>
			<FormItem label="显示购买按钮">
				<i-switch v-model="formItem.content_switch.show_button" size="large">
					<span slot="open">显示</span>
					<span slot="close">隐藏</span>
				</i-switch>
			</FormItem>
...
export default {
	name: 'activityContentSwitchForm',
	props:{
		currIndex:{
			type: [Number,String],
			default: 0,
