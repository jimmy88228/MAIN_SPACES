      ...
      <div class="content">
        <Form ref="formValidate" :model="formItem" :rules="validate" :label-width="140">
          ...
          <FormItem label="推广频次">
            ...
            <FormItem label="每" prop="frequency" :label-width="40">
          ...
          <FormItem label="推广页面">
            ...
            <store-select :data="pageData" type="radio" @del-tag="handlePageClose" v-show="showCustom">
    ...
    confirm (){
      this.$refs.formValidate.validate(valid => {
        ...
        this.$ajax.post(this.id ? this.$api.popupAdvertEdit : this.$api.popupAdvertAdd, {
            ...
            frequency: formItem.boardType == 0 ? 0 : formItem.frequency, //接口没有boardType字段，0代表一次性, 非0代表多次
