...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            onLoadData(page, reqData){
                ...
                return util.ajax.post(util.apiUrl.ErpTagLabelUserList, reqData).then(e =>{
                    let res = e.data || {};
                    if(res.code) {
                        let data = res.data || {};
            ...
            sendCouponReq(data){
                ErpTagLabelUserSend.call(this, data);
            },
            sendWechatReq(data){
                ErpTagLabelUserSend.call(this, data);
            },
            ...
            handleExport () {
                this.$Modal.confirm({
                    ...
                    cancelText: '取消',
                    onOk: () => {
                        return this.$ajax.post(this.$api.ErpTagLabelUserExport,{
                            tag_id: this.tag_id,
                            searchq: this.formData.searchq,
                            page: 1,
                            pageSize: 20
    ...
    //
    function ErpTagLabelUserSend(data){
       if(!this.tag_id) return;
        this.showSpan = true;
        return util.ajax.post(util.apiUrl.ErpTagLabelUserSend, {
            tag_id: this.tag_id,
            ...data
        }).then(e =>{
            let res = e.data || {};
