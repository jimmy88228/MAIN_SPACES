...
<script>
    ...
    import mixin from "./mixins/period.js";
    import searhForm from "./component/searhForm"
    export default {
        name:"smartPeriodList",
        ...
        methods: {
            onLoadData(page, reqData){
                this.showSpan = true;
                return util.ajax.post(util.apiUrl.CycleMarketingList, {
            ...
            removeMarket(id){
                if(!id) return;
                this.showSpan = true;
                return util.ajax.post(util.apiUrl.CycleMarketingRemove, {
                    id: id
                }).then(e =>{
                    let res = e.data || {};
                    if(res.code) {
            ...
            issueMarket(id, type){
                if(!id) return;
                this.showSpan = true;
                return util.ajax.post(util.apiUrl.CycleMarketingIssue, {
                    id: id,
                    status: type
                }).then(e =>{
                    let res = e.data || {};
