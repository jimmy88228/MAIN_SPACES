        ...
        <Col :span="12">
          <FormItem label="活动类型">
            <Select v-model="formSearch.type" class="basic_select">
              ...
              <Option value="fanfankan">生效翻翻看</Option>
              <Option value="shuiguoji">水果机</Option>
              <Option value="yaoyiyao">摇一摇</Option>
              <Option value="zajingdan">砸金蛋</Option>
              <Option value="dazhuanpan">大转盘</Option>
              <Option value="yidianlingquan">一点领券</Option>
            </Select>
          </FormItem>
        </Col>
      <!--  <Col :span="12">
