            ...
            scopedSlots: {
              ...
              handle: () => {
                return <div class="handle_content">
                  {this.rowData.handle.edit ? <router-link tag="a" to={{ name: 'delivery-order-info', params: { sn: this.rowData.delivery_id } }} target="_blank" class="edit_item">查看</router-link> : <span></span>}
