...
<template>
	<div>
		<Modal v-model="showModal" :loading="modalLoading" :title="modalTitle" :width="880" :styles="{top:'20px'}" class="presale-goods-select"
		 @on-ok="onOk">
						...
						<div class="select-box">
							...
							<div>
								<div class="goods-img-box" title="点击查看大图">
									<img :src="(typeof(item.act_img) == 'undefined' ? item.act_img : '')" :alt="item.activity_name"
