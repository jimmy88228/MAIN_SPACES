<template>
  <div class="label-list">
    <Card>
      <list-head title="访问标签" ref="listHead" @on-labelHandle="labelHandle" @on-groupHandle="groupHandle" @on-success="successHandle" :catArr="catArr" :canAction="canCreate"></list-head>
      <div>
...
export default {
  ...
  methods: {
    onLoadData(page, reqData){
        ...
        return util.ajax.post(util.apiUrl.VisitLabelList, params).then(e =>{
            let res = e.data || {};
            if(res.code) {
        let data = res.data || {};
...
function submitGroupReq(data){
  this.showSpan = true;
  return util.ajax.post(util.apiUrl.VisitLabelAddGroup, {
...
function changeStatusReq(data){
  this.showSpan = true;
  return util.ajax.post(util.apiUrl.VisitLabelStatus, data).then(e =>{
    let res = e.data || {};
    if(res.code && res.data) {
...
function submitEditReq(data, type){
  ...
  return util.ajax.post(util.apiUrl.VisitLabelEdit, params).then(e =>{
    let res = e.data || {};
    if(res.code && res.data) {
...
function submitRemoveReq(data, type){
  ...
  return util.ajax.post(util.apiUrl.VisitLabelRemove, params).then(e =>{
    let res = e.data || {};
    if(res.code && res.data) {
      this.$Message.info(res.message || '编辑成功!');
      return this.loadData();
