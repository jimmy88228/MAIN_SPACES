				        	...
				        	<Col :span="22" v-for="(item,index) in selectItems" :name="index" :key="index">
				        		<div class="select-box">
				        			...
				        			<div>
										...
										:style="'background-image:url('+item.goods_brand_image+')'"
				        				title="点击查看大图"></div>
				        			</div>
				        			<div class="clamp2">{{item.goods_brand_name}}</div>
				        		</div>
				        	</Col>
	    		...
	    		<Col :span="20">
	    			...
	    			<div class="table-topbar">
			        	<Form ref="formSearch" :model="formSearch" inline>
			        		...
			        		<FormItem>
					            <Input v-model="formSearch.searchq" style="width:280px;" placeholder="" clearable search enter-button
...
export default {
    ...
    methods: {
    	...
    	initData(){
        	...
        	this.$ajax.post( ( this.$route.fullPath.indexOf('cloud-shop') != -1 ? this.$api.ShopGoodsBrandList : this.$api.goodsBrandList ), {
        		isInit: 2,
			...
			this.columns[ 1 ].render = (h, params) => {
                return h('Row', {
                	...
                	h('Col', {
                		...
                		[h('div', {
	                        style:{
	                        	background: 'url('+params.row.goods_brand_image+') center center / 100% no-repeat #fff',
        ...
        // table 选中事件
        onTableSelect(selection, row){console.log("========");console.log(this.selectModel);
