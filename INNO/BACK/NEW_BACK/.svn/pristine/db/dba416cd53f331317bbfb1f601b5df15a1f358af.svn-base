...
export default {
  ...
  mounted () {
    ...
    // 商品属性批量上传
    this.$refs.batchImport2.openModal(this.$api.goodsAttribute, this.$api.goodsAttributeTpl);
    // 商品参数
    this.$refs.batchImport3.openModal(this.$api.goodsParamAttr, this.$api.goodsParamAttrTpl);
  }
}
</script>
