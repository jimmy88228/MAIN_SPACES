...
<template>
	<div class="pre-sale-form">
		...
		<!--统一活动头-->
		<activityHeaderForm :currIndex="currIndex" headerTitle="预售"></activityHeaderForm>
		
		<!--预售商品选择器-->
		<presaleSelect ref="goods-select" @on-ok="onGoodsSelectOk"></presaleSelect>
	</div>
</template>
...
<script>
	...
	import presaleSelect from '@/views/my-components/presale-goods-select/presale-goods-select';
