			...
			init() {
				...
				if (typeof(this.formItem.row) == 'undefined') {
					...
					this.$set(this.formItem, 'defaultPrize', {
						img: "https://devimgtest.innourl.com/wechat_applet_image/icon/INNO/micro_mall/lottery/sg_bg.png",
						color: "#B3711C"
					});
					this.$set(this.formItem, 'activePrize', {
						img: "https://devimgtest.innourl.com/wechat_applet_image/icon/INNO/micro_mall/lottery/sg_bg_active.png",
						color: "#ECED92"
					});
					this.$set(this.formItem, 'lotteryBtn', {
						img: "https://devimgtest.innourl.com/wechat_applet_image/icon/INNO/micro_mall/lottery/lottery_start.png",
						color: "#fff"
					});
				}
			},
