    ...
    <Card>
      ...
      <Table :loading="tableLoading" :height="tableHeight" :columns="tableColumns" :data="tableData" ref="myTable">
        ...
        <template slot-scope="{ row }" slot="handle">
          ...
          <span v-show="row.handle.import" @click="handleImport(row)"><a>导入组员</a></span>
...
export default {
  ...
  methods: {
    handleImport (row) {
      ...
      this.$refs.batchImport.openModal(handle,this.$api.shopSettingImport, this.$api.shopformBoard);
    },
    clearOptions () {
      this.condition = {
        searchq: ''
