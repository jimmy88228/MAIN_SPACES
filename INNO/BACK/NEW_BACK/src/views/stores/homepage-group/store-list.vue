	...
	export default {
		...
		methods: {
			...
			onLoadData(page, extraData) {
				...
				return this.$ajax.post(this.$api.storeIndexGroupStore, {
					id: this.groupId,
			...
			remove(index, item) {
				...
				return this.$ajax.post(this.$api.storeIndexGroupStoreRemove, {
			...
			batchRemove() {
				...
				this.tableLoading = true;
				return this.$ajax.post(this.$api.storeIndexGroupStoreBatch,{
			...
			transferGroup() {
				...
				this.tableLoading = true;
				this.$ajax.post(this.$api.storeIndexGroupStoreBatch, {
					type: 1,
