  ...
  <PageTopBase>
    ...
    <transition-group name="fade">
      <div class="package-detail-form" v-show="showBaisc" key="basic">
        <Form ref="formValidate" :model="formItem" :rules="ruleValidate" :label-width="140">
          <FormItem label="套餐名称" prop="package_name">
            <Input v-model="formItem.package_name" placeholder="请输入套餐名称" class="basic_input basic_input_fixed" />
          </FormItem>
          ...
          <FormItem label="是否允许自提" prop="self_get">
            <i-switch size="large" v-model="formItem.self_get" true-value="1" false-value="0">
      ...
      <div v-show="!showBaisc" key="goods" class="group-activity-select-wrapper">
        ...
        <goods-page-table ref="goodsTable" :form-item="formItem" :goods-data="selectedData" :id-disabled="idDisabled" @get-data="handlePageData" @get-edit-data="handleEditData"></goods-page-table>
      </div>
    </transition-group>
