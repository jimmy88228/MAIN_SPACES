    ...
    <Card>
      ...
      <Table :loading="tableLoading" :height="tableHeight" :columns="tableColumns" :data="tableData" ref="myTable">
        ...
        <template slot-scope="{ row}" slot="handle">
          ...
          <!-- <span    @click="handleImport(row)"><a>导入商品</a></span> -->
...
export default {
  ...
  methods: {
    ...
    handleImport (row) {
        this.uploadUrl = this.$api.timeLimitActivityGoodsUpload+'/'+row.id;
        console.log(this.uploadUrl)
        this.$refs.batchImport.openModal(this.canCreate, this.uploadUrl, this.$api.timeLimitActivityGoodsTplDownload);
      },
    onImportSuccess () {
        this.loadData();
      },
