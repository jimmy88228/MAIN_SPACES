    ...
    <Form ref="form" :label-width="100" label-colon>
      <Row>
        <Col span="12" class="order_details_item">
          ...
          <FormItem label="订单状态"><p>{{data.order_info.activity_status_str}}</p></FormItem>
          <FormItem label="支付状态"><p>{{data.order_info.pay_status_str }}</p></FormItem>
          <FormItem label="下单用户"><p>{{data.order_info.consignee}}</p></FormItem>
          <FormItem label="下单时间"><p>{{data.order_info.pay_time}}</p></FormItem>
          <FormItem label="订单号"><p>{{data.order_info.activity_sn}}</p></FormItem>
          <FormItem label="支付单号"><p>{{data.order_info.payment_sn}}</p></FormItem>
        </Col>
        <Col span="12" class="order_details_item">
