	...
	export default {
		...
		methods: {
			...
			openModal(index, info) {
				...
				this.imageHeight = this.info.images[index].height;
				this.imageWidth = this.info.images[index].width;
			...
			addMap() {
				...
				this.posterMap.push({
					map_x: 30,
					map_y: this.imageHeight != 0 ? - ( 600 * this.imageHeight / this.imageWidth ) + this.mapW : -200,
					map_width: 100,
					map_height: 100,
					remark: '双击设置链接',
				});
