  ...
  <div class="goods_select">
    ...
    <div class="setting">
      ...
      <ul class="type" v-show="showType">
        ...
        <Button class="item" type="primary" @click="handleSet('enable', true)">状态</Button>
      </ul>
      <div v-show="!showType">
      ...
      this.showType = true;
       if (this.goodsSpectableData.length) {
        this.goodsSpectableData.forEach((item, index) => {
          item[this.currentType] = this.currentType === 'enable' ? this.settingStatus : this.settingDatas;
          this.handleNumber(this.currentType === 'enable' ? this.settingStatus : this.settingDatas, index, this.currentType);
        })
      } else {
