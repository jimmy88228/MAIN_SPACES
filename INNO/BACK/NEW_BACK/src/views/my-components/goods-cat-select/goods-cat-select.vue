		...
		<Modal
	    	...
	    	<Row :gutter="10">
				        ...
				        <Row :gutter="10" class="select-body" :style="getContentHeight">
				        	<Col :span="22" v-for="(item,index) in selectItems" :name="index" :key="index">
				        		<div class="select-box">
				        			...
				        			<div class="clamp2">{{item.cat_name}}</div>
				        		</div>
				        	</Col>
	    		...
	    		<Col :span="20">
	    			...
	    			<Table ref="select-table" row-key="cat_name" :loading="tableLoading" :height="tableHeight" :columns="columns" :data="data"
...
export default {
    ...
    methods: {
    	...
    	initData(){
        	...
        	this.$ajax.post( ( this.$route.fullPath.indexOf('cloud-shop') != -1 ? this.$api.ShopGoodsCatListForSelect : this.$api.goodsCatListForSelect ), {
        		isInit: 2,
        	})
    		.then( (response) => {
