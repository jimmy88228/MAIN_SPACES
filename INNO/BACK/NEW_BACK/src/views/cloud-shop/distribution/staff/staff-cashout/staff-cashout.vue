  ...
  <div class="brand-list">
    ...
    <Modal
        ...
        <Form ref="formSearch" :model="moda3Form">
          ...
          <FormItem label="审核备注" prop="confirm_remark">
            <Input type="textarea" :disabled="true" :rows="3" v-model="moda3Form.confirm_remark"/>
          </FormItem>
...
export default {
  ...
  methods: {
    ...
    onLoadData (page, data) {
      ...
      return this.$ajax.post(this.$api.CloudStaffCashoutList, params)
      .then(response => {
    ...
    handleExport () {
			this.$Modal.confirm({
				...
				cancelText: '取消',
				onOk: () => {
					return this.$ajax.post(this.$api.CloudStaffCashoutListExport, {
            ...this.condition
          }).then((response) => {
    ...
    handleModal2OK () {
      const url = this.currentType === 1 ? this.$api.CloudStaffCashoutCheck : this.$api.CloudStaffCashoutAudit;
