            ...
            scopedSlots: {
              ...
              handle: ({ row }) => {
                return <div class="handle_content">
                  {this.rowData.handle.edit ? <router-link tag="a" to={{ name: 'shop-return-order-info', params: { sn: this.rowData.return_id } }} target="_blank" class="edit_item">查看</router-link> : <span></span>}
                  {row.handle.remarks ?
