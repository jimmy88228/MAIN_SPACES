        ...
        <div class="cev-root" v-bar>
            <div class="bg-shadow padding20 list-box">
                <div class="cev-toolbar">
                    ...
                    <div class="right">
                        <Button type="primary" @click="createAct" v-if="$store.state.authJson.btn_add_special_activity">
                ...
                <Table ref="table" class="table" :columns="columns" :data="list" border>
                    ...
                    <template slot="action" slot-scope="p">
                        <div class="padding-top-10"><Button class="item-table-action" type="primary" size="small" @click="editAct(p.row.id)" v-if="$store.state.authJson.btn_edit_special_activity">编辑</Button></div>
                        <div class="padding-top-10"><Button class="item-table-action" type="primary" size="small" @click="getEnroll(p.row.id)" v-if="$store.state.authJson.btn_check_special_user">查看名单</Button></div>
                        <div class="padding-top-10">
                            <Poptip confirm title="确定删除该活动" @on-ok="deleteAct(p.row)" v-if="$store.state.authJson.btn_remove_special_activity">
