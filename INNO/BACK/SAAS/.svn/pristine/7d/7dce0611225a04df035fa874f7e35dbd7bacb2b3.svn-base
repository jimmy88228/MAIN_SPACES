      ...
      <div class="bg-shadow padding20 list-box">
        <div class="cev-toolbar">
          ...
          <div class="right">
            ...
            <Button type="primary" @click="e=>exportClick()" v-if="$store.state.authJson.btn_export_enroll_user">导出名单</Button>
          </div>
        </div>
        <Table
          ref="table"
        ...
        <div class="left select-all" v-if="$store.state.authJson.btn_set_lottery_user">
