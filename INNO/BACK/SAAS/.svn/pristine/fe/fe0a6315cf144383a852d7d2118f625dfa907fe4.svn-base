        ...
        <div class="cev-root" v-bar>
            <div class="bg-shadow padding20 list-box">
                <div class="cev-toolbar">
                    ...
                    <div class="right">
                        <Poptip confirm title="是否推送资格通知" @on-ok="sendResult" v-if="$store.state.authJson.btn_push_special_user">
                        ...
                        <Upload
                            ...
                            class="_upload"
                            v-if="$store.state.authJson.btn_import_special_user"
                            >
                            <Button type="primary">
                    ...
                    <template slot="action" slot-scope="p">
                        ...
                        <div class="padding10">
                            <Poptip confirm title="确定删除该用户" @on-ok="deleteUser(p.row)">
                                <Button class="item-table-action" size="small" type="error" v-if="$store.state.authJson.btn_remove_special_user">移除</Button>
                            </Poptip>
                        </div>
                    </template>
                </Table>
