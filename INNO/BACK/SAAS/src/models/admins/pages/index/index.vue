        ...
        <div class="cev-root" v-bar>
            <div class="bg-shadow padding20 list-box">
                <div class="cev-toolbar">
                    ...
                    <div class="right">
                        <Button type="primary" @click="showAddDialog" v-if="$store.state.authJson.btn_add_admin_user">新建账号</Button>
                    </div>
                </div>
                <Table
                    ref="table"
                ...
                >
                    ...
                    <template slot="enable" slot-scope="p" v-if="$store.state.authJson.btn_toggle_admin_user">
                        <i-switch
                    ...
                    <template slot="action" slot-scope="p">
                        <Button
                            ...
                            size="small"
                            @click="edit(p.index)"
                            v-if="$store.state.authJson.btn_edit_admin_user"
                        >编辑</Button>
                        <!-- <Button
                            class="item-table-action"
                            type="success"
                        ...
                        >编辑权限</Button> -->
                        <Poptip confirm title="确定删除该账号？" @on-ok="del(p.index)" transfer v-if="$store.state.authJson.btn_remove_admin_user">
                            <Button
                                class="item-table-action"
                                type="error"
                                size="small"
