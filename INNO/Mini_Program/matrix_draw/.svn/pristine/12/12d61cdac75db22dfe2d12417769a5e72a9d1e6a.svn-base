...
function PageJump(obj) {
  ...
  let type = obj.code ? obj.code : "";
  if(!type && !obj.goods_id)return;
  // let type = obj.func_type ? obj.func_type + "" : obj.module_type ? obj.module_type + "" : obj.code ? obj.code:"";
  ...
  switch (type) {
    ...
    case FuncType.pageUrl.type:
      ...
      break;
    default:
      if (obj.id && obj.id != 0 || (obj.goods_id && obj.goods_id != 0)) {
        url = '/pages/micro_mall/goods/goods_info?goods_id=' + (obj.id||obj.goods_id);
      }
      break;
