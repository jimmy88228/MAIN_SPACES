...
const JINGLANGTS = {
  ...
  "icon_url": "https://JLIMG.highwavesports.com/wechat_applet_image/icon/jinlang/",
  "logo_path": "https://JLIMG.highwavesports.com/wechat_applet_image/icon/jinlang/",
  ...
  "api_domain": {
    ...
    "ELECTRICAPI":"https://JLBUYAPI.highwavesports.com"
  },
  "tabbar_list":[
    {
        "pagePath": "pages/micro_mall/index/index",
...
const TBH = {
  ...
  "brand_name_en": "TBH",
  "BRAND_CODE": "TBH",
  "icon_url": "https://proimage.innourl.com/wechat_applet_image/icon/TBH/",
  "logo_path": "https://proimage.innourl.com/wechat_applet_image/icon/TBH/",
  "default_icon_url": "https://proimage.innourl.com/wechat_applet_image/icon/default/",
  "uploadImgUrl": "https://KLIMG.innourl.cn/ImgManager/ImgUpload/UploadImage",
  "uploadMvUrl": "https://KLVIDEO.innourl.cn/ImgManager/MvUpLoad/UploadMv",
  // "videoUrl": "https://innoimage.innourl.cn/",
  "videoUrl": "https://innovideo.innourl.cn/",
  ...
  "webContactUrl": "http://goso.innourl.cn/mobile/customer_service.php",
    ...
    "tagImg":"https://proimage.innourl.com/SAAS_IMAGE/",
    "icon_url":"https://proimage.innourl.com/wechat_applet_image/icon/INNO/",
    "logo_path":"https://proimage.innourl.com/wechat_applet_image/icon/INNO/",
    "default_icon_url":"https://proimage.innourl.com/wechat_applet_image/icon/default/",
    "uploadImgUrl":"https://proimage.innourl.com/ImgManager/ImgUpload/UploadImage",
    "videoUrl":"https://provedio.innourl.com/",
    "webViewUrl":"",
    "api_domain":{
        "MAINAPI":"",
        ...
        "LOTTERYAPI":"https://proactapi.innourl.com/LotteryApi",
        "SECKILLAPI":"https://proskapi.innourl.com/SeckillApi",
        "VOTEAPI":"",
        "VIDEOSHOPAPI":"https://progoodsapi.innourl.com",
        "BARCODEAPI":"https://proqrcodeapi.innourl.com",
...
const YALU = {
  ...
  "webContactUrl": "https://m.yalu.com/mobile/customer_service.php",
  "brand_id": "20",
  "brand_name": "雅鹿",
  "brand_name_en": "YL",
  "brand_code": "YALU",
  "BRAND_CODE": "YALU",
  "tagImg": "https://ylwximg.yalu.com/SAAS_IMAGE/",
  "icon_url": "https://ylwximg.yalu.com/wechat_applet_image/icon/YL/",
  "logo_path": "https://ylwximg.yalu.com/wechat_applet_image/icon/YL/",
  "default_icon_url": "https://ylwximg.yalu.com/wechat_applet_image/icon/default/",
  "uploadImgUrl": "https://ylwximg.yalu.com/ImgManager/ImgUpload/UploadImage",
  "videoUrl": "https://ylwxvideo.yalu.com/",
  "webViewUrl": "https://m.yalu.com;https://www.echatsoft.com",
  "api_domain": {
    "VSLOGAPI": "https://provslogapi.innourl.com",
    "GOODSAPI": "https://progoodsapi.innourl.com",
    "USERAPI": "https://prouserapi.innourl.com",
    ...
    "STAFFAPI": "https://prouserapi.innourl.com",
    "MAINAPI": "",
    "VSLOGAPI": "https://ylwxvslogapi.yalu.com",
    "GOODSAPI": "https://ylwxgoodsapi.yalu.com",
    "USERAPI": "https://ylwxuserapi.yalu.com",
    "BUYAPI": "https://ylwxbuyapi.yalu.com",
    "REGAPI": "https://ylwxregapi.yalu.com",
    "POINTAPI": "https://ylwxintgapi.yalu.com",
    "COLLAGEAPI": "https://ylwxgbapi.yalu.com",
    "PRESALEAPI": "https://ylwxprsapi.yalu.com",
    "PAYAPI": "https://ylwxpayapi.yalu.com",
    "STAFFAPI": "https://ylwxuserapi.yalu.com",
    "MAPAPI": "https://restapi.amap.com",
    "SMKTPAYAPI": "https://ylwxbuyapi.yalu.com",
    "GRASSAPI": "",
    "BARGAINAPI": "",
    "MEMBERCARDAPI": "https://ylwxuserapi.yalu.com",
    "ACTAPI": "",
    "LOTTERYAPI": "",
    "SECKILLAPI": "",
    "VOTEAPI": "",
    "VIDEOSHOPAPI": "https://ylwxgoodsapi.yalu.com",
    "BARCODEAPI": "https://ylwxqrcodeapi.yalu.com",
    "LIVEAPI": "",
    "ELECTRICAPI": ""
  },
  "tabbar_list": [{
...
//     "POINTAPI": "https://promktapi.innourl.com/PointMktApi",
//     "COLLAGEAPI": "https://promktapi.innourl.com/CollageGroupApi",
//     "PAYAPI": "https://promktapi.innourl.com/PresaleApi",
//     "PRESALEAPI": "https://propayapi.innourl.com",
//     "STAFFAPI": "https://prouserapi.innourl.com",
//     "MAINAPI": "",
//     "MAPAPI": "https://restapi.amap.com",
//     //店铺支付
...
function getSetConfig(config = {}){
  ...
  else if (config.brandCode == "GOSO" || config.brandCode == "GOSOG"){
    brandConfig = {
      ...config,
      ...GOSO
    };
  } 
  else if (config.brandCode == "SINGLE_DOG" || config.brandCode == "TANNI" || config.brandCode == "AMS" || config.brandCode == "YNTY" || config.brandCode == "QD" || config.brandCode == "BYGD" || config.brandCode == "SA" || config.brandCode == "YZTY") {
    brandConfig = {
      ...config,
      ...SINGLE_DOG
    };
  ...
  else if (config.brandCode == "TBH" || config.brandCode == "INNO" || config.brandCode == "DY"|| config.brandCode == "DYY" ) {
    brandConfig = {
      ...config,
      ...TBH
    };
  } else if(config.brandCode == "YALU"){
    brandConfig = {
      ...config,
      ...YALU
    };
  }
  else if (config.brandCode == "TBH" || config.brandCode == "INNO") {
    brandConfig = {
      ...config,
      ...TBH
    };
  ...
  if (config.brandCode){
    ...
    config.iconFileName = config.iconFileName || BrandConf[brandConfig.BRAND_CODE].iconFileName || "";
    config.visitApiType = config.visitApiType || BrandConf[brandConfig.BRAND_CODE].API_TYPE || "2";
  }
