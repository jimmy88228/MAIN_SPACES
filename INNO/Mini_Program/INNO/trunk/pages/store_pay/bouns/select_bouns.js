...
function getBonusList(){
  return app.SmktPayApi.getOfflineBonusList({//getOfflineCouponusList({
      params: {
            // pageIndex: this.page,
            ...
            userToken: app.LM.userToken,
            paymentId: this.options.payment_id,
            brandCode: app.Conf.BRAND_CODE,
      },
      other: {
            isShowLoad: true
      ...
      if (e.code == "1") {
            ...
            for (let i = 0 ; i < data.length; i++) {
                ...
                data[i].bonus_id = data[i].bonusId;
            }
          let userChoiceData = app.StorageH.get("userChoiceData") || {};
          console.log("use_coupon", userChoiceData.use_coupon);
            this.setData({
                coupon_list: data,
