// pages/component/address/areaSelect.js
...
Component(app.BTAB({
  ...
  methods: {
    ...
    getRegionList:function(){
          return app.UserApi.getAllRegionList({
               data: {
               ...
               if (e.code == "1") {
                    ...
                    for (var i in areaData) {
                         ...
                         var region_type = areaData[i].region_type;
    ...
    InitRegionData:function(data){
      ...
      var all_dist_data = allData.dist_data;
      var selectVal = this.data.selectVal;
      var prov_index = 0, city_index = 0, dist_index = 0;
      //初始化
      var regionData = {
        prov_data: {
          region_ids: [],
