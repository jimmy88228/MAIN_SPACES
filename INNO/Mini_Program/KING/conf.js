...
let _config = getSetConfig({
  visitApiType:"2", //1:测试环境 ，2：正式环境 3： 雅鹿 4：百家好
  barCodeApiType: "2", //1:测试环境 ，2：正式环境 3： 雅鹿 
  dev: false,
  debug:true,
  brandCode: "GOSO",//"XLH", //JWTEST//ZZYXCODE//KINGCODE//XXRMCODE//XIAICODE//ZZLD//JLY品牌名称
  iconFileName: "GOSO", //JWTY//ZZ品牌icon文件夹//KINGCODE//XA
