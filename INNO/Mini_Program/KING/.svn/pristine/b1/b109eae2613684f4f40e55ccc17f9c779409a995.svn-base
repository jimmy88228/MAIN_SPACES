...
function PageJump(obj) {
  ...
  switch (type) {
    ...
    case FuncType.STAFF.type:
      url = `/pages/micro_mall/distribution_center/apply_for_staff/fill_information/fill_information?order_amount=${obj.order_amount}&dure_agreement=${obj.dure_agreement}&free_num_day=${obj.free_num_day}&page_id=${obj.page_id}&phone=${obj.phone}&userName=${obj.userName}`
      break;
