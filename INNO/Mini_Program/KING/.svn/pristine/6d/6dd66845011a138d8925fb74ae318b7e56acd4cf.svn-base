...
Page(app.BP({
    ...
    onLoad: function(options) {
        ...
        this.setData({
            ...
            'isStoreOrder': options.is_store_order == 1,
            empty_url: empty_url,
    ...
    addImg: function() {
        ...
        WxApi.chooseImage({
            ...
            console.log('jimmy choose',this.data.imgList,res)
            try{
            ...
            WxApi.getImageInfo({
                ...
                wx.uploadFile({
                    ...
                    success: function(res) {
                        console.log('jimmy upload res',res);
                        let data = {};
                        try{
                            data = JSON.parse(res.data);
                        }catch(e){
                            console.log('jimmy catch',e);
                        }
                    ...
                    fail: function(res) {
                        console.log('jimmy upload fail',res) 
                    }
                })
...
function setStorageFnc(type=""){
    ...
    console.log('jimmy storage',storage);
    app.StorageH.set("COMMENT_DATA",storage);
}
...
function getStorageFnc(type=""){
    let p = new Promise((rs,rj)=>{
        ...
        let id = '' + options.order_id + '_' + options.goods_id ;
        let data = storage[id]||{};
        console.log('jimmy getstorage',storage[id],)
        if(!storage[id]){
            rs();
        }else{
            let setData = {};
