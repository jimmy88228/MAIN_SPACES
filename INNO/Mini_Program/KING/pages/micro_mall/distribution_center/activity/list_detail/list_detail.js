...
function loadData(type = 0) {
  if (this.hasMore[type] && !this.isLoading[type] && this.reflash[type] && this.initLabel) {
    setBool.call(this,'isLoading',type,true);
    let str = 'goodsList';
    ...
    app.DistrApi[str]({
      ...
      if (res.code == 1) {
        ...
        setBool.call(this,'hasMore',type,(this.page[type] * app.Conf.PAGE_SIZE) < data.totalCount);
        this.page[type] += 1;
        this.setData({
        ...
        this.value = '';
        setBool.call(this,'hasMore',type,false);
        this.setData({
          [`none[${type}]`]: true
        });
        app.SMH.showToast({
      ...
      this.value = ''
      setBool.call(this,'isLoading',type,false);
...
function setBool(valName,index,bool) {
    this[valName][index] = bool;
    this.setData({
