...
Page(app.BP({
  ...
  selectStore(e) {
    ...
    wx.navigateTo({
      url: `/pages/micro_mall/stores/store_nav?type=selectByGoods&select_store_id=${store_id}&loc_f=0&goods_id=${this.options.goodsId}&goodsNum=${select_goods.select_goods_count || 1}&fromType=sk`,
    })
  },
