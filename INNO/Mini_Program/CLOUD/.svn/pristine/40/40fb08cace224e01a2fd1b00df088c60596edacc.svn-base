...
export const GoodsApiList = {
    ...
    getSumaryGoodsDetailDatm: "/api/Goods/Get_Sumary_GoodsDetailData?goodsId={goodsId}&productId={productId}&colorId={colorId}&userToken={userToken}&issue_id={issue_id}&brandCode={brandCode}",
...
export const PreSaleApiList = {
    ...
    getPresaleOrderDatm:"/api/Presale/GetPresaleOrderData?userToken={userToken}&preOrderId={preOrderId}&bonusIds={bonusIds}&isUsedPoint={isUsedPoint}&brandCode={brandCode}",
...
export const UserApiList = {
    ...
    getUserStoredValueCaptchm: "/api/StoredValue/Get_UserStoredValueCaptcha?userToken={userToken}&brandCode={brandCode}",
