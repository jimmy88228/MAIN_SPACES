...
// import { TestApi } from '../../../helper/manager/http-manager.js';
const app = getApp();
...
function test(data){
  ...
  for(let i = 0,len = pageModelList.length;i<len;i++){
    ...
    if(item.moduleId == 18){
     ...
     true &&  (item.setting = {"type":"t1","row":1,"interval":3,"indicator":"dot","showTitle":true,"images":[{"img":"http:\/\/devimgtest.innourl.com\/SAAS_IMAGE\/images\/INNO\/index\/gallery\/20210202\/20210202175239676_7440182.png","image":"http:\/\/devimgtest.innourl.com\/SAAS_IMAGE\/images\/INNO\/index\/gallery\/20210202\/20210202175239676_7440182.png","title":"\u56fe\u7247\u5e7f\u544a1","width":"720","height":"640","tag":"\u56fe\u7247\u6807\u7b7e1","link":{"code":"qmenu","id":"\/pages\/home\/index","name":"\u9996\u9875","sn":"shopHome","typeName":"[\u5e38\u7528\u5730\u5740]"}}],"open_slide":false,"backgroundColor":"","backgroundImage":"","backgroundPosition":"center"})
     true &&  (item.code = "imageAd");
    }else if(item.moduleId == 20){
     true &&  (item.setting = {"items":[{"title":"\u5bfc\u822a\u4e00","image":"http:\/\/devimgtest.innourl.com\/SAAS_IMAGE\/images\/INNO\/index\/gallery\/20210202\/20210202175239676_7440182.png","tag":"","link":{"code":"pageUrl","id":1249,"name":"\u6d4b\u8bd5\u8bf4","typeName":"\u5fae\u9875\u9762"}},{"title":"\u5bfc\u822a\u4e8c","image":"http:\/\/devimgtest.innourl.com\/SAAS_IMAGE\/images\/INNO\/index\/gallery\/20210204\/20210204103221329_5072337.jpg","tag":"","link":{"code":"goodsCatUrl","id":"2638","name":"cat","sn":"","typeName":"\u5546\u54c1\u5206\u7c7b"}},{"title":"\u5bfc\u822a\u4e09","image":"","tag":"","link":{"code":"goodsCatUrl","id":"2637","name":"\u624b\u8868","sn":"","typeName":"\u5546\u54c1\u5206\u7c7b"}},{"title":"\u5bfc\u822a\u56db","image":"http:\/\/devimgtest.innourl.com\/SAAS_IMAGE\/images\/INNO\/index\/gallery\/20210202\/20210202175239676_7440182.png","tag":"","link":{"code":"pageUrl","id":2329,"name":"MIWA_T2","typeName":"\u5fae\u9875\u9762"}}],"type":"imageText","row":4,"open_slide":true,"gutter":0,"textColor":"#3072B7","open_icon":true,"icon_shape":"circle","backgroundColor":"","backgroundImage":"","backgroundPosition":"top"})
     true &&  (item.code = "imageTextNavigate");
    }else if(item.moduleId == 21){
     true &&  (item.setting = {"goodsGroup":[{"goodsListType":"goodsBrand","goodsListTypeName":"\u5546\u54c1\u54c1\u724c","goodsList":[{"id":"126716","name":"0204"},{"id":"126653","name":"11131"},{"id":"126652","name":"dwe"}],"name":"\u5206\u7ec4\u540d"}],"layout":"two","open_slide":true,"gutter":0,"currTab":"tab0","backgroundColor":"","backgroundImage":"","backgroundPosition":"top"})
     true &&  (item.code = "goodsList");
    }else if(item.moduleId == 22){
     true &&  (item.setting = {"goodsGroup":[{"goodsListType":"goodsCat","goodsListTypeName":"\u5546\u54c1\u5206\u7c7b","goodsList":[{"id":"2576","name":"\u7537\u978b11"}],"name":"\u5206\u7ec4\u540d"}],"backgroundColor":"","backgroundImage":"","backgroundPosition":"top","layout":"list","open_slide":false,"gutter":0,"currTab":"tab0"})
     true &&  (item.code = "goodsList");
     ...
     true &&  (item.setting = {"backgroundColor":"","backgroundImage":"","backgroundPosition":"top"})
     true &&  (item.code = "video");
    }else if(item.moduleId == 25){
     true &&  (item.setting = {"option":{"direction":2,"limitMoveNum":2,"singleHeight":0},"textList":[{"is_enable":true,"text":"AAAAAAAAAAA"},{"is_enable":true,"text":"BBBBBBBBBBBBB"}],"showIcon":true,"type":"primary","fontSize":16,"backgroundColor":"","backgroundImage":"","backgroundPosition":"top"})
     true &&  (item.code = "textScroll");
    }else if(item.moduleId == 8502){
