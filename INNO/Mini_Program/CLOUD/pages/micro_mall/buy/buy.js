...
Page(app.BP({
  ...
  checkValetUse(){
    ...
    if (valetOrderInfo.needSms && valetOrderInfo.isSmsChecked == 0){
      this.ValetModule.valetPhoneSms(this.valetInfo, valetOrderInfo.nextSendSeconds);
    }
  },
  pageCheckValetOrder(e){
    console.log("检测完毕", e);
    // let detail = e.detail || {};
...
function initParam(isClear = false, clearPromote,clearSecPromote = false) {
  ...
  this.reqData = {
    ...
    "cashcouponIds": "",
    "userToken": valetInfo.userToken || app.LM.userToken, //暂时保留
    "fromUserToken": valetInfo.userToken ? app.LM.userToken : "", //暂时保留
