    ...
    <div class="editor-main">
        <div class="main-content">
            ...
            <div class="content-right">
                <div class="content-view">
                    <editor-right-side ref="editorRightSideRef" :commonInfo="commonInfo" :compList="compList" :pageInfo="pageInfo" :canWeixin="canWeixin" :catList="catList"></editor-right-side>
                </div>
            </div>
        </div>
