<template>
    <div class="data-select-area">
        <Select :clearable="clearable" :disabled="disabled" ref='mySelect' :value="selectValue" filterable @on-change="selectChange" @on-clear="selectChange('')" class="basic_select" :class="{ 'full-select': isFullW}" :size="size" :multiple="multiple" :transfer="transfer">
