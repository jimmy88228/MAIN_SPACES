...
const psychicFilesRoutes = [
    ...
    },
    {
        ...
        component: () => import(/*webpackChunkName: "member-psychic-file"*/"@/models/psych-service/psychic/psychic-files/index"),
        meta: {
            removeBg: true,
            hideTitle: true, 
            watermark: true,
...
const memberManageRoutes = [
    {
        ...
        meta: {
            menu: routeMenusKey['peopleGroup'],
            title: "人员分组"
        } 
    },
    // {
    ...
    // },
    {
        name: "registerMember",
        path: "/registerMember",
        component: () => import(/*webpackChunkName: "register-member"*/"@/models/register/member/index"),
        meta: {
            menu: routeMenusKey['registeredUser'],
            title: "注册人员"
        } 
    },
    {
        name: "registerMemberPsychicFiles",
        path: "/registerMemberPsychicFiles",
        component: () => import(/*webpackChunkName: "register-psychic-file"*/"@/models/psych-service/psychic/psychic-files/index"),
        meta: {
            removeBg: true,
            hideTitle: true, 
            watermark: true,
    ...
    {
        name: "registerPsychicFilesReport",
        path: "/registerPsychicFilesReport",
        component: () => import(/*webpackChunkName: "register-psychic-file-report"*/"@/models/survey/activity/assess/report/index"),
        meta: { 
            watermark: true,
            menu: routeMenusKey['registeredUser'],
            title: "心理档案报告"
    ...
    {
        name: "registerPsychicFilesDetail",
        path: "/registerPsychicFilesDetail",
        component: () => import(/*webpackChunkName: "register-psychic-files-detail"*/"@/models/psych-service/psychic/psychic-files/psychic-detail/index"),
        meta: {
            removeBg: true,
            hideTitle: true,
            watermark: true, 
    ...
    {
        name: "registerPsychicFilesMeddle",
        path: "/registerPsychicFilesMeddle",
        component: () => import(/*webpackChunkName: "register-early-warn-meddle"*/"@/models/early-warn/meddle/index"),
        meta: {
            watermark: true,
            menu: routeMenusKey['registeredUser'],
            title: "干预记录"
