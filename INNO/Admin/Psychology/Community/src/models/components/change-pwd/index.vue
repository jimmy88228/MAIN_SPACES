    ...
    <Modal v-model="modalShow" :width="500" title="修改密码">
        <Form :label-width="100" :model="formData" ref="formDataRef" :rules="ruleValidate">
            <FormItem label="旧密码" prop="oldpasswd">
                <Input class="base-input" v-model="formData.oldpasswd" placeholder="输入旧密码"></Input>
            </FormItem>
            <FormItem label="新密码" prop="newpasswd">
                <Input class="base-input" type="password" v-model="formData.newpasswd" placeholder=输入新密码></Input>
            </FormItem>
            <FormItem label="确认新密码" prop="notarizepasswd">
                <Input class="base-input" type="password" v-model="formData.notarizepasswd" placeholder="请再次输入新密码"></Input>
            </FormItem>
        </Form>
        <div slot="footer">
