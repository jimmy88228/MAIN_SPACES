            ...
            },
            {
              ...
              module_data: {
                serviceList: [
                  ...
                  {
                    code: "SURVEY-RECORD",
                    icon: "https://psyimage.innourl.com/v/admintmp/admin/community/general/static/user/SURVEY-RECORD.png",
                    is_enable: 1,
                    name: "测评记录",
                    tip: "提示",
                    type_name: "测评记录"
                  ...
                  {
                    code: "USERINFO-EDIT",
                    icon: "https://psyimage.innourl.com/v/admintmp/admin/community/general/static/user/MY-REPORT.png",
                    is_enable: 1,
                    name: "信息编辑",
                    tip: "提示",
                    type_name: "信息编辑"
                  ...
                  {
                    code: "MY-SUBSCRIBE",
                    icon: "https://psyimage.innourl.com/v/admintmp/admin/community/general/static/user/MY-SUBSCRIBE.png",
                    is_enable: 1,
                    name: "我的预约",
                    tip: "提示",
                    type_name: "我的预约"
