<template>
    <div>
        <rewrite-drawer v-model="drawerShow" :inner="true" :width="450">
                ...
                <Form :label-width="120" :model="examineInfo" ref="examineInfoForm" :rules="ruleValidate">
                    ...
                    <div class="p-r-10">
                        ...
                        <FormItem label="预警等级" prop="level_id" v-if="examineInfo.state == 1">
                            <data-select size="large" class="base-320" type="warn-level" ref="gradeSelectRef" valueKey="id" nameKey="level_name" v-model="examineInfo.level_id"></data-select>
                        </FormItem>
            ...
            <div class="edit-foot" slot="footer" v-if="examineState == 0">
...
export default {
    ...
    methods: {
        showDrawer(examineInfo = {}) {
            ...
            console.log('examineInfo',_examineInfo)
            ...
            return this.$MainApi
                .forewarningSignGrade({
                    data: {
                        ...
                        examine_remark: examineInfo.examine_remark||"",
                        model_id:examineInfo.model_id,
                        model_name: examineInfo.model_name,
                        student_name: examineInfo.get_record && examineInfo.get_record.student_name
                    },
                })
                .then((res) => {
                    if (res.code) {
