                    ...
                    <div class="edit-cont-area">
                        <Form :label-width="100" :model="meddleInfo" ref="meddleInfoForm" :rules="ruleValidate">
                            <FormItem label="评估建议" prop="examine_remark">
                                <Input class="base-320 remark" type="textarea" v-model="meddleInfo.examine_remark"></Input>
                            </FormItem>
                            ...
                            <FormItem label="干预者">
                                <p class="m-l-10">{{studentInfo.student_name}}</p>
                            </FormItem>
                            <FormItem label="预警等级" prop="level_id" v-if="studentInfo.get_waring_user && studentInfo.get_waring_user.user_id">
