<template>
    <div class="activity-report-area" :id="'reportPDFView' + currModelId">
        <div class="report-export-btn">
            <Button @click="exportPDF" icon="md-cloud-download" :loading="putLogIng">导出PDF</Button>
            <!-- <Button @click="exportWord" icon="md-cloud-download" :loading="putLogIng">导出word</Button> -->
        </div>
        <div class="report-cont" :id="'reportPDF' + currModelId" >
                ...
                <div class="report-item">
                    ...
                    <div class="item-content flex-s-c">
                        <div class="cont-item flex1">
                            <span class="bold cont-l m-r-10">测评对象：</span><span>{{userInfo.student_name}}</span>
                        </div>
                        <div class="cont-item flex1">
                            <span class="bold cont-l m-r-10">学校：</span><span>{{userInfo.school_name}}</span>
                        </div>
                        <div class="cont-item flex1">
                            <span class="bold cont-l m-r-10">学号：</span><span>{{userInfo.student_number}}</span>
                        </div>
                        <div class="cont-item flex1">
            ...
            <div class="report-item ">
                <div class="item-header page-splite-flag">维度表</div>
                <div class="item-content page-splite-flag" style="padding:0px;border: 0 none;">
            ...
            <div class="report-item ">
                <div class="item-header page-splite-flag">测评分析</div>
                <div class="">
                    <div class="page-splite-flag" v-for="(item, index) in reportAnalyseList" :key="index">
...
import { initPdf, getPdf } from "@/helper/utils/export-pdf.js";
import { exportWord } from "@/helper/utils/export-word.js"
...
export default {
    ...
    methods: {
            ...
            return this.$MainApi[req]({
                ...
                .then((res) => {
                    if (res.code) {
                        ...
                        // this.modelInfo = this.userInfo.get_model || {};
                        this.modelTime = this.userInfo.record_complete_time
                        this.inited = true;
                        this.initPDF();
                    }
                });
        ...
        exportPDF(){
            ...
            let studentName = userInfo.student_name ? userInfo.student_name + '-' : '';
            let name = studentName + userInfo.model_name;
            this.putLogIng = true;
            return this.$MainApi.putLog({
                ...
                .then((res) => {
                    ...
                    setTimeout(()=>{
                        this.putLogIng = false;
                    }, 500)
                })
            
        },
        exportWord(){
            exportWord('/template/person-report.docx', {
                ...this.userInfo,
                reportItems: this.reportItems,
                reportAnalyseList: this.reportAnalyseList
            }, '个人报告');
        }
    },
};
...
<style lang="css">
 /* @import 'nb-fe-pdf/src/print.css'; */
 </style>