...
import chooseOrganize from "./components/choose-organize.vue";
...
export default {
    ...
    methods: {
        ...
        actChooseCustomer(customer_data){
            this.$refs["chooseCustomerRef"] && this.$refs["chooseCustomerRef"].showModal({ customerData: customer_data })
        },
        ...
        actChooseOrganize(structure_list){
            this.$refs["chooseOrganizeRef"] && this.$refs["chooseOrganizeRef"].showModal({ organizeData: structure_list })
        },
