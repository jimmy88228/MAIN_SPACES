        ...
        <div id="main-header" class="main-header flex-b-c" v-if="!_isThird">
            <div class="flex-s-c header-platform">
                ...
                <div class="flex-c-s flex-col text-box">
                    <div v-if="_structureName" class="logo-name">{{_structureName}} <span v-if="_structureType == 'edu_school' && _loginAdmin.school_code">(ID: {{_loginAdmin.school_code}})</span></div>
...
export default {
    ...
    methods: {
        ...
        //     item.href = require("./assets/logo.png");
        // }
    },
    mounted(){
        // this.initFavicon();
