                ...
                <Form :label-width="100" :model="studentInfo" ref="studentInfoForm" :rules="ruleValidate">
                    <drawerForm>
                        ...
                        <div slot="content">
                            ...
                            <FormItem label="学号" prop="student_number">
                                <custom-input placeholder="请输入学号" regType="studentId" class="base-200"
                    ...
                    <drawerForm layoutCustomStyle="border-top:none">
                        ...
                        <FormItem label="校区" prop="campus_id">
                            <campusSelect placeholder="请选择校区" :hideEdit="true" class="base-200" v-model="studentInfo.campus_id"
                        ...
                        <FormItem label="班级" prop="grade_id" v-if="drawerShow">
                            <data-select placeholder="选择班级" class="base-200" type="class" ref="gradeClassSelectRef"
                                :value="studentInfo.grade_id" :params="{ campus_id: studentInfo.campus_id ,grade:studentInfo.class_grade,school_year:studentInfo.school_year}"
        ...
        methods: {
            showDrawer(studentInfo = {}) {
                ...
                this.$nextTick(() => {
                    ...
                    console.log("studentInfo",JSON.parse(JSON.stringify(this.studentInfo)))
                    this.changeCampus();
                })
            },
            ...
            changeCampus(change) {
                console.log("变化 change", change)
                this.$nextTick(() => {
                        this.loadSchoolGradeData()
                    if (change){
                        this.studentInfo.grade_id = 0;
            ...
            changeSchoolYear(data) {
                console.log("变化 data", data)
                // if (data){
                    console.log(JSON.parse(JSON.stringify(this.studentInfo)),"this.studentInfo")
                ...
                this.$set(this.studentInfo, "grade_id", 0)
                    this.$nextTick(()=>{
                    console.log(this.studentInfo.campus_id ,this.studentInfo.class_grade,this.studentInfo.school_year)
            ...
            updateStudentInfo() {
                ...
                let req = studentInfo.user_id ? 'studentUpdate' : 'studentAdd';
