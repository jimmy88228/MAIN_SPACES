<template>
    <div class="file-detail">
                ...
                <div class="m-cont trans-main-box" :class="{active:moreActive}">
                    <div class="trans-box trans-box-front" :class="{active:!moreActive}">
                        ...
                        <div class="info-area">
                            ...
                            <p class="info-row">
                                <span class="row-tip">学号</span>
                                <span class="row-cont">{{studentInfo.student_number}}</span>
                            </p>
                            <div class="info-row">
                    ...
                    <div class="trans-box trans-box-behind" :class="{active:moreActive}">
                        <div class="detail-box">
                            ...
                            <div class="msg-box">
                                <div class="msg-item">
                                    <div class="msg-tip">所在学校</div>
                                    <div class="msg-content">{{studentInfo.school_name||"未知"}}</div>
                                </div>
                                <!-- <div class="msg-item">
                                    <div class="msg-tip">联系方式</div>
                                    <div class="msg-content">{{studentInfo.mobile_phone||"未知"}}</div>
                                </div> -->
                                <div class="msg-item">
                                    <div class="msg-tip">学号</div>
                                    <div class="msg-content">{{studentInfo.student_number||"未知"}}</div>
                                </div>
                                <div class="msg-item">
                                    <div class="msg-tip">性别</div>
                                    <div class="msg-content">{{studentInfo.student_sex_str||"未知"}}</div>
                                </div>
                                <!-- <div class="msg-item">
                                    <div class="msg-tip">年龄</div>
                                    <div class="msg-content">{{studentInfo.age||"未知"}}</div>
                                </div>
                                <div class="msg-item">
                                    <div class="msg-tip">婚姻</div>
                                    <div class="msg-content">{{studentInfo.marriage_str||"未知"}}</div>
                                </div>
                                <div class="msg-item">
                                    <div class="msg-tip">生育</div>
                                    <div class="msg-content">{{studentInfo.bear||"未知"}}</div>
                                </div>
                                <div class="msg-item">
                                    <div class="msg-tip">学历</div>
                                    <div class="msg-content">{{studentInfo.qualification||"未知"}}</div>
                                </div> -->
                            </div>
                        </div>
                    </div> 
        ...
        <moreModel ref="moreModelRef" :studentInfo="studentInfo" :type="pageQuery.type"></moreModel>
    </div>
</template>
        ...
        methods: {
                ...
                this.$MainApi
                    ...
                    .then((res) => {
                        if (res.code) {
                            ...
                            this.modePoints = data.student_mode_points;
                            this.$emit("studentDataCallback", {
                                personInfo: data.student_Info || {},
                                relateData: data.relate_data || []
                            });
                        }
                    })
                    .finally(() => {
            ...
            getMeddle(){
                this.$router.push({
                    ...
                    query: {
                        userId: this.userId,
                        name:this.studentInfo.member_name||""
                    },
                });
            },
            moreInfo(){
