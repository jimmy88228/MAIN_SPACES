                ...
                <div class="edit-cont" v-bar>
                    <div class="edit-cont-area">
                        <Form :label-width="100" :model="schoolInfo" ref="formDataRef" :rules="ruleValidate">
                            ...
                            <!-- <FormItem label="学校类型" prop="school_type">
                                <RadioGroup v-model="schoolInfo.school_type">
                                    <Radio :label="item.key" v-for="item in schoolTypeList" :key="item.key">{{item.name}}</Radio>
                                </RadioGroup>
                            </FormItem> -->
