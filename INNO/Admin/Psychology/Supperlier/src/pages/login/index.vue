<template>
    <div id="login-layout" class="bg-page">
        ...
        <chooseSupplier ref="chooseSupplierRef" @callback="chooseSupplierCallback"></chooseSupplier>
        <!-- <slideVerify 
...
import chooseSupplier from "./components/choose-supplier.vue";
        ...
        getLogin(){
            LM.login(this.fromData.account, this.fromData.password).then((res) => {
                ...
                if(data.select_state == 1){
                    ...
                    this.$refs["chooseSupplierRef"] && this.$refs["chooseSupplierRef"].showModal({ supplierData })
                } else {
