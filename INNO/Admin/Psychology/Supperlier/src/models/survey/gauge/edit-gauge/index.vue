<template>
  <hold-layout :isFull="true" class="edit-gauge" layoutCustomStyle="padding: 0;" :isShowFormSave="((baseInfo.publish_state>=0 && baseInfo.publish_state != 1) || curTab == 'report')" @_cancel="cancel" @_save="save()">
