<template>
    <Form class="choose-problem-form no-tip m-b-10 p-10" inline :label-width="80">
      <Form-item label="筛选维度">
        <dimensionSelect :canEdit="false" :showData="hasDimensions" :multiple="false" @change="search()" :modelId="modelId" v-model="searchForm.dimensions" placeholder="选择维度"></dimensionSelect>
      </Form-item>
    </Form>
</template>
