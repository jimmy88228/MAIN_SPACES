<template>
  <div class="page-editor-right-side">
    <div class="side-content">
      <Tabs class="side-tabs" v-model="currTabName" type="card" :animated="false" name="editor">

        <TabPane class="side-tabs-pane bg-page" v-bar name="CURR_COMPONENT" label="组件" tab="editor">
          <div>
            <!--组件表单池-->
            ...
            <!--视频模块-->
            <videoMdForm v-if=" compInfo.module_type == 'VIDEO-MD' " :compInfo="compInfo" :pageInfo="pageInfo"></videoMdForm>
            <!--音频模块-->
            <audioMdForm v-if=" compInfo.module_type == 'AUDIO-MD' " :compInfo="compInfo" :pageInfo="pageInfo"></audioMdForm>
            <!--文章模块-->
            <articleMdForm v-if=" compInfo.module_type == 'ARTICLE-MD' " :compInfo="compInfo"></articleMdForm>
            <!--富文本模块-->
            <richTextMdForm v-if=" compInfo.module_type == 'RICH-TEXT-MD' " :compInfo="compInfo" :pageInfo="pageInfo" :commonInfo="commonInfo"></richTextMdForm>
            <!--个人中心 -- 头部-->
        ...
        <TabPane class="side-tabs-pane bg-page" v-bar name="COMPONENTS" label="组件管理" tab="editor">
          <pageSettingComp :compList="compList" :commonInfo="commonInfo"></pageSettingComp>
        </TabPane>
        <TabPane  v-if="pageType != 'REPORT'" class="side-tabs-pane bg-page" v-bar name="PAGE" label="页面设置" tab="editor">
          <div>
            <!--页面设置表单-->
...
import richTextMdForm from "./widgets/rich-text-md/rich-text-md-form";
