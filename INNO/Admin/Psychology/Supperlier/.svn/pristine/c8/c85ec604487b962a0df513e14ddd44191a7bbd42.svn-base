<template>
  <div class="problems-view-area">
    <div class="view-cont">
      <div class="view-detail flex-b-c" v-if="problemsInfo.status != 1">
        <!-- <div>题目编辑</div>
        <div class="edit-area" @click="changeState" :class="isEdit ? 'editIng' : ''">
          <div class="edit-area-move">
            <div class="edit-point flex-c-c">
              <Icon type="md-settings" class="m-r-5"/>编辑
            </div>
            <div class="edit-point flex-c-c">
              <Button style="width:100%;height:100%;" type="primary">保存编辑</Button>
            </div>
          </div>
        </div> -->
...
.problems-view-area{
  ...
  .view-detail{
    padding: 15px;
    box-shadow: 0px 1px 7px rgb(230, 230, 230);
    position:relative;
    z-index: 2;
  }
  .edit-area{
