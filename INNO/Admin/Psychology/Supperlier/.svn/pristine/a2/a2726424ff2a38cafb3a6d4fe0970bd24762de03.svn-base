<template>
    <div class="custom-page-module-item" :class="{'selected': selected}" :style="getModuleStyle(itemInfo.setting)">
...
.custom-page-module-item:hover {
    .line-i {
        opacity: 0.5;
    }
}
.custom-page-module-item.selected {
    // border-color: #0883cc;
    .line-i {
        opacity: 1;
    }
