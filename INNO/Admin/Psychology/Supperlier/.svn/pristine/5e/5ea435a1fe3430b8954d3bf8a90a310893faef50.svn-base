<template>
    <div class="form-box article-md">
        ...
        <mdForm type="video" :pageInfo="pageInfo" :styleBox="styleBox" :dynamic_setting="dynamic_setting" :compInfo="compInfo" @styleSwitch="styleSwitch" @cardClick="cardClick" @addGroup="addGroup" @setDynamic="setDynamic"></mdForm>
    </div>
</template>
