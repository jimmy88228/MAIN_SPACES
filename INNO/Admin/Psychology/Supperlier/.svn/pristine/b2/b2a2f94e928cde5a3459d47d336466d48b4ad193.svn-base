    ...
    <div class="editor-image-ad-view">
        ...
        <div v-else class="empty">
            <div class="img-box flex-c-c">
                <img v-if="typeImg" :src="typeImg" alt="" class="img-logo">
                <div v-else-if="typeText" class="bold">{{typeText}}</div>
            </div>
...
export default {
    ...
    computed: {
        ...
        typeText(){
            return this.keyInfo[this.type] && this.keyInfo[this.type].text || "";
        },
        dynamic_setting(){
