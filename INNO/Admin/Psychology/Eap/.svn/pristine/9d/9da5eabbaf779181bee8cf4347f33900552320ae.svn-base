          ...
          <div v-for="(item,index) in module_data.serviceList" :name="index" :key="item.code" class="img-item-list">
            ...
            <div class="flex">
              <div class="p-l-5 p-r-10">
                <img-view display="block" uploadType="custom_page" :width="60" :img="item.icon" :isCustomChoose="false" @selectImg="(data)=>{selectImage(index, data)}" @delImg="removeImage(index)"></img-view>
                <p>
