                        ...
                        <div class="dropdown-item ">
                            <template v-if="item.isEdit">
                                <div class="item-line" @click.stop="">
                                    <Input class="item-input" :ref="'dropInput' + item.campus_id" v-model="item.campus_name" @on-blur="confirmEditItem(item, index)"></Input>
                                </div>
                            </template>
                            <template v-else>
                                <div class="item-line">
            ...
            <DropdownItem divided name="add">
                <div class="add-area" @click.stop="">
                    <div class="add-input-area">
                        <Input type="textarea" v-model="addData.campusName" class="add-input" placeholder=""></Input>
