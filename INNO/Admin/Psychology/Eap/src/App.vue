        ...
        <div id="main-header" class="main-header flex-b-c" v-if="!_isThird">
            <div class="flex-s-c header-platform">
                <div class="main-logo" v-if="!_structureName">
                    <img class="logo-img" :src="adminStaticUrl + '/logo.png'" />
...
export default {
    ...
    data() {
        return {
            ...
            focus: false,
            menuSelect: '',
            adminStaticUrl: Conf.ADMIN_STATIC
        };
    },
    computed: {
        adimData() {
    ...
    methods: {
        ...
        setShortcutIcon(logo){
            logo = logo || Conf.ADMIN_STATIC + "/logo.png";
