...
Page(app.BP({
    ...
    getActivityDetail() {
        ...
        .then(e => {
            ...
            return this.commission.getCommission("COLLAGEGROUP", goodsId, this.activity_id, true);
        }).catch(e => { });
    },
    getGroupList() {
        var that = this;
...
function getCollageGroupJoinList() {
    return app.CL_CollageApi.getCollageGroupJoinList({
        params: {
            activityId: this.activity_id,
...
function getCollageGroupGoodsDetail(d) {
    ...
    var join_id = this.data.join_id;
    var select_style = this.data.select_style;
    return app.CL_CollageApi.getCollageGroupGoodsDetail({
        params: {
            activityId: this.activity_id,
...
function checkProductNumber(productNum) {
    ...
    return app.CL_CollageApi.checkProductNumber({
        params: {
