...
export const ActApiList = {
  ...
  getBuyBonusOrderStaffList: "/api/BuyBonus/Get_BuyBonusOrderStaffList?staffId={staffId}&pageSize={pageSize}&pageIndex={pageIndex}&searchStr={searchStr}&brandCode={brandCode}&beginDate={beginDate}&endDate={endDate}&staffIds={staffIds}&manageStoreId={manageStoreId}", // 购券礼包订单列表
  getBuyBonusOrderPayDetail: "/api/BuyBonus/Get_BuyBonusOrderPayDetail?orderId={orderId}&brandCode={brandCode}", // 购券礼包订单详情
}
// 智慧支付
