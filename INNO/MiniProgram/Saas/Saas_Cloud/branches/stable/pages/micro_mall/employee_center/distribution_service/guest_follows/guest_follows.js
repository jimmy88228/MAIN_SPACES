// pages/micro_mall/employee_center/distribution_service/guest_follows/guest_follows.js
...
Page(app.BP({
    ...
    onTap(e){
        ...
        if(type=="time_show"){
            ...
            wx.navigateTo({
              url: '/pages/micro_mall/employee_center/distribution_service/guest_follows/sync-member/sync-member',
            })
        }
    },
}))
