// pages/component/custom/embed_custom/embed_custom.js
...
function getItemData(options = {}) {
  // test.call(this);
  let moduleList = options && (options.ModuleList || options.moduleList) || [];
  moduleList && mapData.call(this, moduleList);
  this.setData({
    imgDomain: options.ImgDomain || options.imgDomain || '',
    moduleList: options.ModuleList || options.moduleList || [],
  })
