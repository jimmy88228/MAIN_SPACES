...
Page(app.BP({
    data: {
        ...
        options: {},
        newOpt: {},
        storePhoneShow: false, // 是否显示门店联系电话或呼叫门店电话
    },
    ...
    toNavigate(e){
        let lat = parseFloat(this.data.newOpt.lat || this.data.options.lat) || 0;
        let lon = parseFloat(this.data.newOpt.lon || this.data.options.lon) || 0;
