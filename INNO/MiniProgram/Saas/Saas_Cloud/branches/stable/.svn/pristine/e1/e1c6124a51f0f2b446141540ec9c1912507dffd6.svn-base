...
function loadData() {
    return app.CL_BargainApi.getHagglePriceActivityDetail({
        params: {
...
function getHagglePriceActivity() {
    if (!this.loading) {
        this.loading = true;
        return app.CL_BargainApi.getHagglePriceActivityGoodsDetail({
            params: {
                activityId: this.activityId || 0
            },
            other: {
...
function createBargain() {
    return app.CL_BargainApi.createUserHagglePriceActivity({
        data: {
            activityId: this.activityId || 0,
