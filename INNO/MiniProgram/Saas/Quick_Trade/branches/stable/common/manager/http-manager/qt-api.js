...
export const QT_OrderReturnApiList = {
  ...
  applyCancelOrder:"/api/AfterSale/ApplyCancelOrder?orderId={orderId}",
  checkAfterSale:"/api/AfterSale/CheckAfterSale?Id={Id}&check={check}",
  refund:"/api/AfterSale/Refund?Id={Id}&refundKind={refundKind}",
  uploadShipping:"/api/AfterSale/UploadShipping?Id={Id}&shippingId={shippingId}&refundType={refundType}&shippingName={shippingName}&shippingType={shippingType}&invoiceNo={invoiceNo}",
  applyAfterSale:{
