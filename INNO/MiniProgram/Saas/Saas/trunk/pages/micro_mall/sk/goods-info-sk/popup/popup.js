...
Component(app.BTAB({
    ...
    properties: {
        ...
        select_goods:{
          ...
          value: {},
          observer:function(n,o){
            console.log('select_goods',n);
            n && this.setData({
              productInfo:n.productInfo || {},
              goodsExtend:n.goodsExtend || {},
              goodsTotalInfo:n.goodsTotalInfo || {},
            })
          }
        }, 
        colorArr:{
    ...
    methods: {
        ...
        sizeSelect(e) {
          ...
          // if (size_id == this.data.cur_size_id) return //取消选中
          this.setData({
            cur_size_id : size_id == this.data.cur_size_id ? 0 : size_id || 0
          })
