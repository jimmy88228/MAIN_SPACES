...
Page(app.BP({
    ...
    selectColor(e) {
        ...
        // 切换图片
        let specImgIndex = 0,
            selectedColor = this.data.colorList && this.data.colorList[colorIndex],
            colorId = selectedColor.colorId || 0,
            imgList = this.data.goods_info && this.data.goods_info.imgList || [];
        imgList.some((v,i) => {
    ...
    return app.BargainApi.getHagglePriceActivityDetail({
        ...
        if (res.code == 1) {
            ...
            let goodsInfo = {
                ...
                goodsRepertoryAmount: data.goodsRepertoryAmount, // 商品总活动库存数量
            ...
            initCountDownData.call(this,activityInfo);
...
function listen() {
    ...
    this.listenLoginStatuId = app.EB.listen("LoginStateChange", () => {
        if (app.LM.isLogin) loadData.call(this);
        this.setData({
            isLogin: app.LM.isLogin
        });
    });
