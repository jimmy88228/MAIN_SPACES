...
Component(app.BTAB({
    ...
    goodsGroupId: 0, // 礼品分类id
    // bounsGroupId: 0, // 优惠券分类id
    hasMore: true,
    page: 0,
    attached() {
    ...
    methods: {
        ...
        setGroupId(tabIndex, id){
            let type = (tabIndex == 1 ? 'goods' : 'bonus');
            this[`${type}GroupId`] = id
        },
        handleFilterSearch(){
            this.installData(1)
        },
...
function getIntegralBonusGoods(tabIndex) {
    ...
    // let groupingId = (tabIndex == 0 ? this.bounsGroupId : this.goodsGroupId) || 0;
    let groupingId = (tabIndex == 0 ? 0 : this.goodsGroupId) || 0;
    let params = {
