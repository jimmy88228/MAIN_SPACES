  ...
  app.BTAB({
    ...
    methods: {
      ...
      subscriptNormal(e){
        ...
        return WxSub.wxSubscribeHelp({tplsList,bool,subState,subStateAll}).then(res=>{
          console.log('订阅 wxSubscribeHelp then',res)
        })
      ...
      showNormal(){
        let shareList = this.data.shareList;
        shareList.splice(2);
        this.setData({shareList},()=>this.show());
      }
    }
  })
);
