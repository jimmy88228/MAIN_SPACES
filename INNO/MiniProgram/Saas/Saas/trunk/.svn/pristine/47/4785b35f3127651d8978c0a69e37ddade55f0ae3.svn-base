...
Component(app.BTAB({
    ...
    methods: {
        jump(e) {
            ...
            wx.navigateTo({
              url: `/pages/micro_mall/distribution_center/distribution_orders_lists/distribution_orders_lists?currentIndex=${currentIndex}&type=${this.properties.commission ? 'commission' : ''}`,
            })
        }
    }
}))