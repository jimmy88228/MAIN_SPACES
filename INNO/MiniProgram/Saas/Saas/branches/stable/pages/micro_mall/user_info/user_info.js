...
Page(app.BP({
  ...
  getConf(){
    return app.sysTemConfig("show_account_manage").then(res=>{
      this.setData({
        isShowAccount:res.Value||0
      })
    })
  },
  bindChange (e) {
...
function saveCallback(){
  ...
  app.LM.saveUserInfo(user_infos);
  wx.navigateBack();
}
function initDate(){
...
function afterUserInfoSaved(){
  return checkDisplayReceivedCoupons.call(this)
