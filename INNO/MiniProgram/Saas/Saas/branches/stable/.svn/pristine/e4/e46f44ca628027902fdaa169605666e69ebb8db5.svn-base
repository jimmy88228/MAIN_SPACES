...
export const GoodsApiList = {
    ...
    getSumaryGoodsDetailData: "/NewGoodsApi/api/Goods/Get_Sumary_GoodsDetailData?goodsId={goodsId}&productId={productId}&colorId={colorId}&userToken={userToken}&issue_id={issue_id}&brandCode={brandCode}",
    ...
    get_GoodsPackageInfo:"/api/GoodsPackage/Get_GoodsPackageInfo?packageId={packageId}&brandCode={brandCode}&userToken={userToken}",
    get_UserGoodsPackageDetail:"/api/GoodsPackage/Get_UserGoodsPackageDetail?packageId={packageId}&brandCode={brandCode}&userToken={userToken}",
    ...
    // 商品价格解释图
    getGoodsDetailBottomImg: "/api/Goods/GetGoodsDetailBottomImg?goodsId={goodsId}&brandCode={brandCode}",
    //加价购
    ...
    */
    ...
    get_Goods_DimensionPlan:"/api/Goods/Get_Goods_DimensionPlan?goodsId={goodsId}&brandCode={brandCode}",
    
    // 新微页面
    getCustomPageInfo:"/NewGoodsApi/api/Goods/GetCustomPageInfo?param={param}&pageType={pageType}&brandCode={brandCode}&userToken={userToken}",
    get_CustomPageDataScript:"/api/Page/Get_CustomPageDataScript?pageId={pageId}&brandCode={brandCode}",
    checkCanBuy:"/api/Goods/CheckCanBuy?goodsId={goodsId}&userToken={userToken}&brandCode={brandCode}"
} 
// 用户
export const UserApiList = {
    ...
    */
    ...
    postResetUserToErp:{
      u: "/api/user/PostResetUserToErp",
      m: "post"
    },
    getHuiYouActivityList:"/api/HuiYou/GetActivityList?storeId={storeId}&pageIndex={pageIndex}&pageSize={pageSize}&brandCode={brandCode}&userToken={userToken}&searchText={searchText}",
...
export const RegApiList = {
    ...
    registerByUserProfile1:{
      u: "/api/Wechat/RegisterByUserProfile1",
      m: "post"
    },
    updateUserPortrait:{
...
export const BuyApiList = {
    ...
    changePriceByStaff: {
      u: "/api/Order/ChangePriceByStaff",
      m:"post"
    },
    ...
    Update_Order_action:"/api/Order/Update_Order_action?orderId={orderId}&orderSn={orderSn}&refundId={refundId}&userToken={userToken}&brandCode={brandCode}",
    sceneCheck:{
      u: "/api/Wechat/SceneCheck",
      m: "post"
    },
    
    checkOrderInventory:"/api/Order/CheckOrderInventory?userToken={userToken}&orderId={orderId}&brandCode={brandCode}"
} 
// 支付
export const PayApiList = {
    getAppletPrepayId: Conf.LiveType =='channels' ? "/api/pay/weixin3.36/pay_v3.0.php?order_id={order_id}&pay_type={pay_type}&pay_channel={pay_channel}":"/api/pay/weixin3.36/pay_v1.0.php?order_id={order_id}&pay_type={pay_type}",
}
// 新支付
...
export const CollageApiList = {
    ...
    getSumaryGoodsProductInfoByShippingStore: "/api/CollageGroup/Get_Sumary_GoodsProductInfoByShippingStore?userToken={userToken}&brandCode={brandCode}&goodsId={goodsId}&storeId={storeId}",
    //检测数量
...
export const PreSaleApiList = {
    ...
    Post_PresaleSubscriptionRecord: {
      u: '/api/Presale/Post_PresaleSubscriptionRecord',
      m: 'post'
  }
}
// 积分
export const PointApiList = {
    ...
    getPointMkGoodsGrouping: "/api/PointMk/GetPointMkGoodsGrouping?pageIndex={pageIndex}&pageSize={pageSize}&brandCode={brandCode}",
...
export const DistributionApiList = {
    ...
    getUpdateFansRemarkName: "/api/StaffDstb/Get_UpdateFansRemarkName?userId={userId}&remarkName={remarkName}&brandCode={brandCode}",
...
export const BrandApiList = {
    ...
    getMenuListNew: "/api/Brand/Get_MenuList_New?brandCode={brandCode}",
    // 客服配置
...
export const GrassApiList = {
  ...
  Op_SharePublish_Shares:{
      u:"/api/Grass/Op_SharePublish_Shares",
      m:"post"
  },
  publish_Commnet:{
...
export const SmktPayApiList = {
    ...
    postOfflineOrderRewardRelease: {
      u: "/api/SmktPay/Post_offline_order_reward_release",
      m: "post"
    },
    //历史纪录
