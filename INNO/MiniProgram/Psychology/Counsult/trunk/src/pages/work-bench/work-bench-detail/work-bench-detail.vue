...
<script>
  ...
  const pageOption = Page.BasePage({
    ...
    destroyed() {
      structureManage.removeStructureInfo()
    },
    methods: {
      initList() {
        this.evalList = [];
      ...
      createCode(item = {}) {
        if (this.appletCodeLoading) return
        this.appletCodeLoading = true;
