    ...
    methods: {
      ...
      clickItem(e) {
        ...
        if (clickItem.contentType == 'audio') {
          ...
          this.jumpAction(
            `/pages/course/course-video/course-video?activityId=${activityId}&courseId=${courseId}&contentId=${contentId}&cIndex=${e.cIndex}&sIndex=${e.sIndex}&chaptersIndex=${e.chaptersIndex}`
          )
