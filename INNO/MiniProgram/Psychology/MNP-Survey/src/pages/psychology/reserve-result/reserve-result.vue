  ...
  <frame-box :showPage="mixShowPage">
    <template v-slot:body>
      <view class="answer-result flex-col flex-c-c">
        ...
        <image class="submit-suc" :src="requireStatic('/answer-result-bg.jpg')" mode="scaleToFill" />
  ...
  const pageOption = Page.BasePage({
    ...
    methods: {
      logout() {
        ...
        uni.reLaunch({
          url: `/pages/startup/startup?id=${app.PM.getParams("initId")||0}&schoolId=${app.PM.getParams("schoolId")||0}`,
        });
      },
      getResult() {
