      ...
      <template v-if="(!isTest && showVideo) && videoDetail.videoUrl">
        <view class="video-content">
          <video @ended="videoEnded" @pause="videoPause" id="video"
            ...
            class="videoInfo" @play="playVideo" @fullscreenchange="fullscreenchange" :src="videoDetail.videoUrl" :autoplay="videoOptions.autoplay"
  ...
  const pageOption = Page.BasePage({
    ...
    methods: {
      getSysConf(callback) {
        ...
        let isTest = app.IM.bsnUserInfo.isTest == 1
        this.isTest = isTest;
