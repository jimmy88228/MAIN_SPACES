            ...
            <view class="scale">
              ...
              <view v-for="(item,i) in rangeList" :key="i" :style="{width:scalePercent}">
                ...
                <view class="scale-ball" v-if="item.selected" :style="{left:`calc(${coefficientPercent} - 18rpx)`}">
                  <!-- <view :animation="animationBall" class="scale-ball" v-if="item.selected"> -->
  ...
  const pageOption = Page.BasePage({
    ...
    computed: {
      ...
      rangeList() {
        ...
        this.$nextTick(() => {
          setTimeout(() => {
            // animationBall = uni.createAnimation({
            //   duration: 1000,
            //   timingFunction: 'easy'
            // })

            // this.animationBall = animationBall;
            ...
            // 执行动画
            // animationBall.left(this.coefficientPercent).translateZ(0).step()

            // this.animationBall = animationBall.export()
          }, 600);
        })
