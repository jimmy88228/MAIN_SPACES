		...
		<view class="map_view">
			...
			<view class="msg_box" @click="toNavigate">
				...
				<view class="store_info flex-s-c font-22">
					<image :src="setStaticAddress('/nearby-address/address.png')" mode="aspectFit" />{{detailData.address}}</view>
				<view v-if="detailData.telephone" class="store_info flex-s-c font-22">
					<image :src="setStaticAddress('/nearby-address/telephone.png')" mode="aspectFit" />{{detailData.telephone}}
				</view>
				<view class="store_info flex-s-c font-22">
					<image :src="setStaticAddress('/nearby-address/time.png')" mode="aspectFit" />{{detailData.serviceTime}}
				</view>
				<view class="btn_box">
					<view class="btn_l" @click.stop="toNavigate">
						<image :src="setStaticAddress('/nearby-address/btn_l.png')" mode="aspectFit" class="img_btn_l"></image>
						<view>路线导航</view>
					</view>
					<view v-if="detailData.telephone" class="btn_r" :class="detailData.telephone ? '':'disabled'" :data-phone="detailData.telephone" @click.stop="tap_phone">
						<image :src="setStaticAddress('/nearby-address/btn_r.png')" mode="aspectFit" class="img_btn_r"></image>
						<view>呼叫机构</view>
					</view>
					<view v-if="detailData.psychicHotline" class="btn_l btn_heart" :class="detailData.psychicHotline ? '':'disabled'"
						...
						<image :src="setStaticAddress('/nearby-address/heart_color.png')" mode="aspectFit" class="img_btn_l">
						</image>
						<view>心理咨询热线</view>
					</view>
					<view v-if="detailData.residentBookPhone" class="btn_r btn_store" :class="detailData.residentBookPhone ? '':'disabled'"
						...
						<image :src="setStaticAddress('/nearby-address/store_color.png')" mode="aspectFit" class="img_btn_r">
						</image>
						<view>线下驻场预约</view>
					</view>
				</view>
				...
				<template v-slot:content>
					<view class="popup-content" @click="hidePopup">
						<view class="popup_telephone"  :style="{'opacity':popupShow?1:0,'transition':'0.4s all'}">
							...
							<image v-show="showPsychicHotline" :src="setStaticAddress('/nearby-address/heart_telephone.png')" mode="widthFix"  :data-phone="detailData.psychicHotline" @click.stop="tap_phone"/>
							<image v-show="showResidentBookPhone" :src="setStaticAddress('/nearby-address/store_telepphone.png')" mode="widthFix"  :data-phone="detailData.residentBookPhone" @click.stop="tap_phone"/>
						</view>
