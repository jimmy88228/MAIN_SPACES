    ...
    <template v-slot:body>
      <view class="answer-result flex-col flex-c-c">
        ...
        <view class="button-group">
          ...
          <button v-if="showSXIndex" class="btn flex-c-c C_7f" @click="reLaunchAction" data-url="/pages/index/index">
            前往首页
          </button>
          <button v-else class="btn flex-c-c C_7f" @click="reLaunchAction" data-url="/pages/platform-index/platform-index">
            前往首页
          </button>
        </view>
      </view>
