    ...
    methods: {
      ...
      getPhoneNumber({
        ...
        return this.$Http(this.$Apis.getPhoneNumberPlatform, {
          ...
          this.formData.mobilePhone = res.data || "";
      ...
      confirm(e) {
        ...
        this.updateUserInfo("updateUserInfo").then(() => {
          setTimeout(() => {
            this.backAction()
          }, 300);
        }).catch((err) => {
      ...
      updateUserInfo() {
        ...
        let api = this.$Apis.updateUserInfo;
        // 修改个人信息
        ...
        return this.$Http(api, {
            data: {
              ...this.formData,
              supplierCode: Conf.supplierCode
            },
            other: {
              isShowLoad: true,
            },
