...
export const platform = {
	...
	SupplierApiList: {
		getSupplierConfigPlatform: "/supplier/getSupplierConfig",
		getSupplierInfoPlatform: "/supplier/getSupplierInfo",
	},

	WechatApiList: {
		createSessionPlatform: {
			u: "/wechat/createSession",
			m: "post"
		},
		createSessionPlatformV2: {
			u: "/wechat/createSessionV2",
			m: "post"
		},
		getPhoneNumberPlatform: {
			u: "/wechat/getPhoneNumber",
			m: "post"
		},
		getAppletCodePlatform:  "/wechat/getAppletCode"		
	},
	
	UserApiList: {
		checkUserCustomerPlatform: "/user/checkUserCustomer",
		getLastLoginCustomerPlatform: "/user/getLastLoginCustomer",
	},

	PageApiList: {
		getHomePagePlatform: "/page/getHomePage",
		getMinePagePlatform: "/page/getMinePage",
		getTargetPagePlatform: "/page/getTargetPage",
	},
	CustomerApiList: {
		getCustomerConfigPlatform: "/customer/getCustomerConfig",
	}
}
