<template>
	<view class="index-page">
		<custom-page :safeArea="TabbarSafeArea" :scroll-height="scrollHeight" :customType="customType" :nav-full="true" :navIsTransparent="true" ref="customPageRef"></custom-page>
		<share ref="shareModule"></share>
		<cuTabbar :showSXIndex="showSXIndex" ref="tabbar" selectedKey="index"></cuTabbar>
	</view>
</template>
...
import SSXI from "@/common/manager/showSXIndex-manager.js";
	...
	const pageOption = Page.BasePage({
		...
		methods: {
			...
			getPage() {
				return this.$Http(this.$Apis.getHomePagePlatform, {
					other: {
						isShowLoad: true
					}
				}).then(res => {
