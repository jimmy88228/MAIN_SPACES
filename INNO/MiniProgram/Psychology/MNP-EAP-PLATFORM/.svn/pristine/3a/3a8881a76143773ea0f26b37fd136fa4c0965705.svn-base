<template>
  <view class="service-box">
    ...
    <work-bench :safeArea="TabbarSafeArea" ref="workBench" @loadSuccess="loadOrganizeSuccess" @selected="jumpDetail"></work-bench>
  </view>
</template>
...
<script>
  ...
  const pageOption = Page.BasePage({
    ...
    methods: {
        ...
        switch (code) {
         case "SURVEY-ACTIVITY":
          ...
          case "USERINFO-EDIT":
            ...
            break
          case "MY-REPORT":
            url = "/pages/report/report-list/report-list"
            break
          case "MY-SUBSCRIBE":
      ...
      jumpDetail(id) {
        console.log(id)
        this.jumpAction(`/pages/work-bench/work-bench-detail/work-bench-detail?id=${id}`)
      },
