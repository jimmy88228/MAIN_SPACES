<template>
  <view
    class=""
    :class="!isEmpty ? 'bg_f7 report-list' : 'bg_fff report-list-empty'"
  >
              ...
              <view class="relative">
                <image
                  class="report-item-image"
                   :src="item.logo ? item.logo : staticAddress+activityIcon"
                        @error="imgerror($event, i, itemIndex)"
                  mode="aspectFill"
                ></image>
                <image
                  class="report-icon absolute"
                  :src="staticAddress+reportIcon"
                  mode="scaleToFill"
                />
              </view>
