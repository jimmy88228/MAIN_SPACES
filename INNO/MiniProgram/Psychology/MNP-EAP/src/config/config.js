...
let config = {
	env: 'prod', // 环境:dev, prod, test （h5的环境下，只填写dev 就可以，可以根据域名来判断）
	log: true,
	brandCode: 'SURVEY_SXFW', // SURVEY_GZHG,中华人民共和国广州海关;SURVEY_SXFW,上馨心理咨询中心; SURVEY_INNO,英朗企业eap;SURVEY_GDHD,省航道;
	platformSrc: 'WXAPP',
